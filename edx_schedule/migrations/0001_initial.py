# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-03-05 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('policy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edx_schedule.DatePolicy')),
        ...
        migrations.AddField(
            ...
            name='policy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='edx_schedule.DatePolicy'),
        ),
